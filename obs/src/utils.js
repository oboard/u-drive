...
const obsAllowedEvent = [
  ...
  "ObjectChanged:*",
  "ObjectChanged:Rename",
  "ObjectChanged:Truncate",
  "ObjectChanged:Modify",
];
...
Utils.prototype.initFactory = function (
  ...
  if (
    typeof checksumAlgorithm === "string" &&
    checksumAlgorithm.toLowerCase() === "sha256"
  ) {
...
Utils.prototype.makeParam = function (methodName, param) {
      ...
      if (
        ...
        for (let _key of Object.keys(meta.parameters)) {
          ...
          if (
            ...
            (_keyValue === null ||
              _keyValue === undefined ||
              (Object.prototype.toString.call(_keyValue) ===
                "[object String]" &&
                _keyValue === ""))
          ) {
  ...
  if (xml) {
    if (model.data && model.data.md5) {
      this.checkAlgorithm === ContentSHA256
        ? (exheaders[
            `${signatureContext.headerPrefix}${ContentSHA256.toLowerCase()}`
          ] = this.bufSHA256(xml, "hex"))
...
Utils.prototype.v4Auth = function (opt, methodName, signatureContext) {
  opt.headers[signatureContext.headerPrefix + "content-sha256"] =
    CONTENT_SHA256;
...
Utils.prototype.createV2SignedUrlSync = function (param) {
  ...
  for (let i = 0; i < queryParamsKeys.length; i++) {
    ...
    if (
      (!isShareFolder || key.toLowerCase() !== "policy") &&
